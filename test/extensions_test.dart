...
void main() {
  group('Pruebas de la extensión capitalize', () {
    ...
    test('No modifica los caracteres que no son letras al inicio (ejemplo con signo)', () {
    ...
    test('Capitaliza correctamente cuando la primera letra es minúscula y el resto está en mayúsculas', () {
      expect('aREA'.capitalize(), 'Area');
    });

    test('Mantiene la parte no alfabética intacta y capitaliza solo el primer carácter alfabético', () {
